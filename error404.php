  ...
  <section class="error-page" aria-labelledby="error-title">
    <div class="error-page__content">
      <div class="error-page__compass" aria-hidden="true">
        <span class="error-page__compass-dot"></span>
      </div>
      <p class="error-page__eyebrow">Error 404</p>
      <h1 id="error-title">This page went off the map.</h1>
      <p class="error-page__message">
        Every word finds its way, but this link did not.<br>
        Head back and we will point you in the right direction.
      </p>
      <a class="error-page__button" href="index.php">
        Back to home
