            ...
            <div class="col-lg-9 col-md-11 col-sm-12 col-12">
               <div class="tc-contain">
                  <ol class="legal-list">
                     <li>
                        <h2>1.Who we are</h2>
                        <p>Placeholder legal copy. The client supplies the final wording and it drops into this template without changing the layout. Each section keeps the same heading and paragraph treatment so the page stays readable at length.</p>
                     </li>
                     <li>
                     ...
                     <li>
                        <h2>5.Certified translations</h2>
                        <p>Placeholder legal copy. The client supplies the final wording and it drops into this template without changing the layout. Each section keeps the same heading and paragraph treatment so the page stays readable at length.</p>
                     </li>
                     <li>
                        <h2>6.Revisions</h2>
